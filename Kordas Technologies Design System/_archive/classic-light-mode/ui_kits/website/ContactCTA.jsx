  ...
  return (
    <section id="contact" className="kt-section kt-section-dark">
      <div className="kt-container kt-contact-grid">
        <div>
          <span className="kt-eyebrow" style={{ color: '#60a5fa' }}>UMÓW ROZMOWĘ</span>
          <h2 style={{ color: '#fff' }}>Pierwsza konsultacja jest <span style={{ color: '#60a5fa' }}>bezpłatna</span>.</h2>
          <hr className="kt-rule-blue" style={{ marginTop: 16 }} />
        ...
        {!sent ? (
          ...
          <div className="kt-contact-form kt-contact-success">
            <i data-lucide="check-circle-2" width="48" height="48" style={{ color: '#16a34a' }}></i>
            <h3 style={{ color: '#0f172a', marginTop: 12 }}>Dziękuję, {form.name || 'do usłyszenia'}.</h3>
            <p style={{ color: '#475569' }}>Otrzymałem Twoje zapytanie. Odpowiem na <strong>{form.email}</strong> w ciągu 24h roboczych.</p>
